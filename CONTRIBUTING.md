...
issue](https://github.com/cisagov/guacscanner-docker/issues) in this
...
request](https://github.com/cisagov/guacscanner-docker/pulls), you will
...
pyenv virtualenv <python_version_to_use> guacscanner-docker
pyenv local guacscanner-docker
