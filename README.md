...
```console
docker run cisagov/guacscanner:0.0.2
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:0.0.2
    ```
...
|-----------|-------------|
|`cisagov/guacscanner:0.0.2`| An exact release version. |
