...
```console
docker run cisagov/guacscanner:1.1.6
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:1.1.6
    ```
...
|-----------|-------------|
|`cisagov/guacscanner:1.1.6`| An exact release version. |
