...
```console
docker run cisagov/guacscanner:1.1.1-rc.1
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:1.1.1-rc.1
    ```
...
|-----------|-------------|
|`cisagov/guacscanner:1.1.1-rc.1`| An exact release version. |
...
```console
docker build \
  --build-arg VERSION=1.1.1-rc.1 \
  --tag cisagov/guacscanner:1.1.1-rc.1 \
