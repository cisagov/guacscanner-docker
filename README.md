...
```console
docker run cisagov/guacscanner:1.1.11
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:1.1.11
    ```
...
|-----------|-------------|
|`cisagov/guacscanner:1.1.11`| An exact release version. |
...
```console
docker build \
  --build-arg VERSION=1.1.11 \
  --tag cisagov/guacscanner:1.1.11 \
