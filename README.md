...
```console
docker run cisagov/guacscanner:0.0.2-rc.2
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:0.0.2-rc.2
    ```
...
|-----------|-------------|
|`cisagov/guacscanner:0.0.2-rc.2`| An exact release version. |
...
```console
docker build \
  --build-arg VERSION=0.0.2-rc.2 \
  --tag cisagov/guacscanner:0.0.2-rc.2 \
