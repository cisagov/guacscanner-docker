...
```console
docker run cisagov/guacscanner:1.1.13-rc.2
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:1.1.13-rc.2
    ```
...
|-----------|-------------|
|`cisagov/guacscanner:1.1.13-rc.2`| An exact release version. |
...
```console
docker build \
  --build-arg VERSION=1.1.13-rc.2 \
  --tag cisagov/guacscanner:1.1.13-rc.2 \
