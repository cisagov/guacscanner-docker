...
```console
docker run cisagov/guacscanner:1.2.1-rc.5
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:1.2.1-rc.5
    ```
...
| --------- | ----------- |
| `cisagov/guacscanner:1.2.1-rc.5` | An exact release version. |
...
```console
docker build \
  --tag cisagov/guacscanner:1.2.1-rc.5 \
