...
```console
docker run cisagov/guacscanner:1.2.1
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/guacscanner:1.2.1
    ```
...
| --------- | ----------- |
| `cisagov/guacscanner:1.2.1` | An exact release version. |
